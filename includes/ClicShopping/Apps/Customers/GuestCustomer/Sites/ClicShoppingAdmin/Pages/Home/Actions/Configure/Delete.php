<?php
  ...
  class Delete extends \ClicShopping\OM\PagesActionsAbstract
  {
    ...
    public function execute()
    {
      ...
      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_GuestCustomer->getDef('alert_module_uninstall_success'), 'success', 'guest_customer');
    ...
    private static function removeMenu()
    {
      ...
      $Qcheck = $CLICSHOPPING_Db->get('administrator_menu', 'app_code', ['app_code' => 'app_customers_guest_customer']);
      ...
      if ($Qcheck->fetch()) {
        ...
        $QMenuId->bindValue(':app_code', 'app_customers_guest_customer');
        $QMenuId->execute();
        ...
        $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_customers_guest_customer']);
      }
    }
  }