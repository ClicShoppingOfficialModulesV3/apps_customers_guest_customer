<?php
  ...
  class ar_create_guest_account
  {
    ...
    public function __construct()
    {
      ...
      $this->title = CLICSHOPPING::getDef('module_action_recorder_create_guest_account_title');
      $this->description = CLICSHOPPING::getDef('module_action_recorder_create_guest_account_description');

      if ($this->check()) {
        if (defined('MODULE_ACTION_RECORDER_CREATE_GUEST_ACCOUNT_EMAIL_MINUTES')) {
          $this->minutes = (int)MODULE_ACTION_RECORDER_CREATE_GUEST_ACCOUNT_EMAIL_MINUTES;
    ...
    {
      return defined('MODULE_ACTION_RECORDER_CREATE_GUEST_ACCOUNT_EMAIL_MINUTES');
    }
    ...
    public function install()
    {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          'configuration_title' => 'What do you want for the minimum minutes per e-mail for one person for guest account ?',
          'configuration_key' => 'MODULE_ACTION_RECORDER_CREATE_GUEST_ACCOUNT_EMAIL_MINUTES',
    ...
    {
      return array('MODULE_ACTION_RECORDER_CREATE_GUEST_ACCOUNT_EMAIL_MINUTES');
    }
  }
